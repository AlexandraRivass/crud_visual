...
if (!$p) die("Error: No se encontró el propietario con ID $id");
?>
<!DOCTYPE html>
<html lang="es">
<head>
    ...
    <title>Editar Propietario — Fauna Granada</title>
...
<body>
    ...
    <div class="pagina_interior">
        <div class="cabecera_pagina mb-3">
            <h1 class="cabecera_titulo"><i class="fa-solid fa-pen me-2"></i>Editar Propietario</h1>
            <a href="../../../../view/tabla_propietarios.php" class="cabecera_volver"><i class="fa-solid fa-arrow-left"></i> Volver a propietarios</a>
        </div>
        <div class="tarjeta_formulario">
            <p class="titulo_formulario">Editando: <span><?php echo htmlspecialchars($p['nombre']); ?></span></p>
            <form method="POST" action="../modificar/modificar_propietario.php">
                ...
                <div class="grupo_campo"><label>Nombre</label><input type="text" name="nombre" placeholder="<?php echo $p['nombre']; ?>"></div>
                <div class="grupo_campo"><label>Apellido</label><input type="text" name="apellido" placeholder="<?php echo $p['apellido']; ?>"></div>
                <div class="grupo_campo"><label>Teléfono</label><input type="number" name="num_telef" placeholder="<?php echo $p['num_telef']; ?>"></div>
                <div class="grupo_campo"><label>Email</label><input type="email" name="email" placeholder="<?php echo $p['email']; ?>"></div>
                <div class="grupo_campo"><label>DNI <small style="color:#999;font-weight:400">(no editable)</small></label><input type="text" name="dni" maxlength="9" placeholder="<?php echo $p['Dni']; ?>" disabled></div>
                <div class="fila_botones">
                    <button type="submit" class="btn_guardar"><i class="fa-solid fa-floppy-disk me-1"></i> Guardar cambios</button>
                    <a href="../../../../view/tabla_propietarios.php" class="btn_cancelar"><i class="fa-solid fa-xmark me-1"></i> Cancelar</a>
                </div>
            </form>
        </div>
    </div>
